// 📧 Envía el correo de seguimiento con la guía de rastreo al cliente
...
export default defineEventHandler(async (event) => {
  ...
  try {
    const res = await fetch(storeUrl + '/api/admin/send-tracking-email', {
      method: 'POST',
    ...
    console.error('Error enviando correo de seguimiento:', e)
