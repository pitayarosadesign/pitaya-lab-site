<template>
  <div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
      ...
      <a :href="storeUrl + '/faq'" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-primary-600 transition-colors">
...
async function handleSave() {
  ...
  try {
    ...
    await $fetch('/api/site/config', {
      method: 'PUT',
      body: { entries: [{ key: 'faq_page', value: { ...config } }] },
    })
