    ...
    <section class="relative py-24 bg-gradient-to-b from-amber-50 to-white overflow-hidden">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto text-center">
          <span class="text-amber-600 font-semibold text-sm uppercase tracking-wider">{{ pageContent.header.badge || 'Legal' }}</span>
...
const pageContent = reactive({
  ...
  sections: [
    ...
    {
      title: '9. Privacidad',
      content: '<p>El tratamiento de sus datos personales se realiza conforme a nuestro <a href="/privacy" class="text-primary-600 hover:text-primary-700 underline">Aviso de Privacidad</a>, el cual forma parte integral de estos Términos y Condiciones.</p>'
    },
    {
      title: '10. Aviso sobre referencias a terceros',
      content: '<p>Los nombres de aromas "Xcaret" y "Vidanta" utilizados en nuestros productos son referencias meramente <strong>inspiracionales</strong> y descriptivas de la experiencia sensorial que evocan. PITAYA LAB no tiene ninguna afiliación, vínculo, patrocinio o asociación con los hoteles, marcas turísticas o titulares de dichos nombres. El uso de estas referencias se realiza con fines descriptivos y de identificación de la experiencia olfativa del producto.</p>'
    },
    {
...
async function loadConfig() {
  ...
  try {
    ...
    console.warn('Usando datos estáticos para Términos (fallback):', e.message)
  }
}
