<template>
  <div>
    ...
    <section class="py-20 bg-white/50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14">
          <span class="text-primary-600 font-semibold text-sm uppercase tracking-wider">Descubre</span>
          <h2 class="text-3xl md:text-4xl font-serif font-bold text-earth-900 mt-2 mb-4">
            Nuestros Productos
          </h2>
          <p class="text-earth-600 max-w-2xl mx-auto">
            Velas de soya perfumadas, aceites aromáticos y brumas que transforman tu hogar 
    ...
    <section class="py-20 bg-white/70">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14">
          <span class="text-primary-600 font-semibold text-sm uppercase tracking-wider">Aromas</span>
          <h2 class="text-3xl md:text-4xl font-serif font-bold text-earth-900 mt-2 mb-4">
            El arte de la fragancia
          </h2>
          <p class="text-earth-600 max-w-2xl mx-auto">
            Cada aroma ha sido cuidadosamente seleccionado para ofrecerte una experiencia única.<br />
    ...
    <section class="py-20 bg-gradient-to-r from-primary-900 to-earth-900">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-primary-200 text-lg mb-8 max-w-2xl mx-auto">
          Descubre nuestra colección completa en Amazon y encuentra la fragancia perfecta para cada momento.
        </p>
        <a
          :href="AMAZON_LINK"
          target="_blank"
...
<script setup>
import { products, SCENTS, brandValues } from '~/products/data'
...
const scentsWithImages = SCENTS.filter(s => s.image)
const scentsWithoutImages = SCENTS.filter(s => !s.image)
</script>
